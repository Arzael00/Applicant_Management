...
<?php endif; ?>
        ...
        <div class="text-left mt-4">
            <div class="text-left">
                <a class="text-start underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\applicant-management\resources\views/auth/login.blade.php ENDPATH**/ ?>